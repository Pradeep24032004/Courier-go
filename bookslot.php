<?php
     ...
     if($_SERVER['REQUEST_METHOD'] == "POST")
     {
         ...
         if(!empty($cust_name) && !empty($cust_id))
         {
  
             //save to database
             //$cust_id = random_num(10);
             $query = "insert into book_slot(cust_id,cust_name,phone_no,address) values ('$cust_id','$cust_name','$phone_no','$address')";
...
.bd-placeholder-img {
    ...
    <div id="box">
		...
		<form method="post">
			<div style="font-size: 80px;margin: 20px;color: black;">Slot Booking</div>
            <h1>customer id</h1>
			...
			<h1>address</h1>
			<input id="text" type="text" name="address"><br><br> <br><br>  
