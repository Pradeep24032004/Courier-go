<?php
     ...
     if($_SERVER['REQUEST_METHOD'] == "POST")
     {
         ...
         if(!empty($review) )
         {
             ...
             $query = "insert into give_review(rating,review) values ('$rating','$review')";
...
.bd-placeholder-img {
    ...
    <div id="box">
		...
		<form method="post">
			<div style="font-size: 80px;margin: 20px;color: black;">Give Review</div>
		    <h1>Rating</h1>
			<input id="text" type="number" name="rating" placeholder="Enter rating in number(out of 5)"><br><br>
			<h1>Review</h1>
			<input id="text" type="text" name="review" placeholder="Write your review here(in text)"><br><br>
