  ...
  <div class="container py-4">
    ...
    <div class="p-5 mb-4 bg-light rounded-3">
      <div class="container-fluid py-5">
        <h1 class="display-5 fw-bold">Update Courier Location</h1>
        <p class="col-md-8 fs-4">When you require an urgent courier service, why waste time with long-winded delivery networks when you don’t need to? With Couriergo, you’ll have a nationwide network of professional courier drivers at your fingertips ready for collection and delivery of your goods on the very same day. With an in-app messaging system, quick bookings for repeat orders, and the ability to rate your driver, we make managing your deliveries a breeze for both individuals and businesses alike.</p>
        <button class="btn btn-primary btn-lg" type="button" ><a href = "courier.php" class = "btn btn-outline-light btn-lg px-4 me-mid-2">Update Courier Location</a></button>
      </div>
    </div>
    ...
    <div class="row align-items-md-stretch">
      <div class="col-md-6">
        <div class="h-100 p-5 text-bg-dark rounded-3">
          <h2>Customer Courier Details</h2>
          <p>We’re not your average courier company, and we’re focused on disrupting an outdated industry in dire need of innovative technological advancements. At Courier go, we leverage the most advanced technologies to provide an expansive range of fully traceable on-demand courier services. Leave those complicated tracking codes in the past, simply create an account, book your delivery online or via the app, and track your driver from start to finish.</p>
          <button class="btn btn-outline-light" type="button"><a href = "courierdetails.php" class = "btn btn-outline-light btn-lg px-4 me-mid-2">Check Courier Details</a></button>
        </div>
      </div>
      <div class="col-md-6">
